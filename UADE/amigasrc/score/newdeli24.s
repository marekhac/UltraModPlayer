...
* $300	input message flag

* $0A00 -
* $1000	exec base (-6*EXECENTRIES == -6 * 210)

* TODO
* cust.an_unbidden_eye: exec allocsignal
...
harmlesslist	dc	CacheClearU,Forbid,Permit,Enable,Disable,0
...
novolfunc
	* call initsound
	...
	bne.b	timernotset
	* if dtg_Timer was set non-zero in dtp_initsound, use ciabplayer
	lea	delibase(pc),a5
	tst	dtg_Timer(a5)
	beq.b	timernotset
	bsr	settimer
...
notimerdev	moveq	#tderrmsg1e-tderrmsg1,d0
	lea	tderrmsg1(pc),a0
	bsr	putmessage
	bra	dontplay
tderrmsg1	dc.l	SHD_GENERALMSG
	dc.b	'OpenDevice(): Only timer.device supported',0
tderrmsg1e	even
...
waitiomsg1	dc.l	SHD_GENERALMSG
	dc.b	'WaitIO(): This function is not implemented yet!'
waitiomsg1e
	even
mywaitio	push	all
...
nociabresource	bra	dontplay

myopenresource	cmp.b	#'c',(a1)
...
bit0zero
	...
	moveq	#0,d0
	rts
ciabremint	lea	mylevel6(pc),a0
	move.l	a0,$78.w
	move	#$3800,intena+custom
	move	#$3800,intreq+custom
	moveq	#0,d0
	rts
...
mylevel5
mylevel6	move	#$3800,intreq+custom
	rte
...
vectab	dcb	3,$64
	...
	dcb	2,$74
	dcb	1,$78
* FOLLOWING LINES MUST BE SET TO MyLevel1,MyLevel2, ... (in myinitints)
