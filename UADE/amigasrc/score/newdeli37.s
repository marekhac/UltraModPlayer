...
debuginfomacro	macro
	dc.b	\1, 0
	even
	dc.l	\2-debug_info
	endm

debug_info	debuginfomacro	'uade debug info', debug_info
	debuginfomacro	'check module', checkmodule
	debuginfomacro	'init player', initplayer
	debuginfomacro	'check sub songs', CheckSubSongs
	debuginfomacro	'init volume', initvolume
	debuginfomacro	'init sound', initsound
	debuginfomacro	'start int', startint
	debuginfomacro	'interrupt', trapcall
	dc.l	0
